...
def migrate(cr, version):
    ...
    deactivated_providers = env["payment.provider"].search([("code", "=", "pagos360"), ("state", "=", "disabled")])
    activated_providers = env["payment.provider"].search([("code", "=", "pagos360"), ("state", "!=", "disabled")])
